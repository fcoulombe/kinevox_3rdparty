...
ELSE()
	...
	if (${WIN32})
	   ...
	   set(COLLADA_LIBRARY_XML ${LIBXML2_LIBRARIES})  
       set(COLLADA_LIBRARY_PCRE ${PCRE_LIBRARIES})
	endif()
	#optimized
	...
	#debug
	SET(COLLADA_DEBUG_LIBRARY ${COLLADA_DEBUG_LIBRARY} debug ${COLLADA_LIBRARY_UTF}${LIB_SUFFIX})
	SET(COLLADA_DEBUG_LIBRARY ${COLLADA_DEBUG_LIBRARY} debug ${COLLADA_LIBRARY_PCRE}${LIB_SUFFIX})
	SET(COLLADA_DEBUG_LIBRARY ${COLLADA_DEBUG_LIBRARY} debug ${COLLADA_LIBRARY_COLLADABaseUtils}${LIB_SUFFIX})
	SET(COLLADA_DEBUG_LIBRARY ${COLLADA_DEBUG_LIBRARY} debug ${COLLADA_LIBRARY_COLLADAFramework}${LIB_SUFFIX})
	
	SET(COLLADA_DEBUG_LIBRARY ${COLLADA_DEBUG_LIBRARY} debug ${COLLADA_LIBRARY_XML}${LIB_SUFFIX})
	SET(COLLADA_DEBUG_LIBRARY ${COLLADA_DEBUG_LIBRARY} debug ${COLLADA_LIBRARY_GeneratedSaxParser}${LIB_SUFFIX})
	SET(COLLADA_DEBUG_LIBRARY ${COLLADA_DEBUG_LIBRARY} debug ${COLLADA_LIBRARY_MathMLSolver}${LIB_SUFFIX})
	SET(COLLADA_DEBUG_LIBRARY ${COLLADA_DEBUG_LIBRARY} debug ${COLLADA_LIBRARY_COLLADASaxFrameworkLoader}${LIB_SUFFIX})
